...
sudo cp /opt/hassbian/suites/files/appdaemon.conf /home/homeassistant/appdaemon/appdaemon.conf
...
echo
echo "To continue have a http://appdaemon.readthedocs.io/en/latest/"
echo
